...
public class MapFragmentView {
    ...
    private void createRoute() {
        ...
        places.put("current", new RouteWaypoint(new GeoCoordinate(59.9955082,30.2945393)));
        places.put("Сити Молл", new RouteWaypoint(new GeoCoordinate(60.0055137,30.3005185)));
        places.put("АШАН", new RouteWaypoint(new GeoCoordinate(60.0087375,30.297511)));
        places.put("2 шага", new RouteWaypoint(new GeoCoordinate(60.0276602,30.4134961)));
        ...
        RouteWaypoint startPoint = places.get("current");
        RouteWaypoint destination = places.get(GlobalValues.currentStore);
